...
export function FeatureSection() {
  return (
    <section className="py-16 md:py-24 bg-white relative" id="features">
        ...
        >
          {FEATURES.map((feature) => (
            <motion.div
              ...
              className="bg-white p-6 md:p-8 rounded-2xl md:rounded-[2rem] border border-[#E5E7EB] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group overflow-hidden relative cursor-default"
            >
